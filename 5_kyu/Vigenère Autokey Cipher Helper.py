# https://www.codewars.com/kata/52d2e2be94d26fc622000735/train/python
...
code = VigenereAutokeyCipher('password', 'abcdefghijklmnopqrstuvwxyz')
print(code.encode('amazingly few discotheques provide jukeboxes'))
